...
theorem Term.fold_accu_Option_function
    ...
    Term.accuM
      ...
      t
      i = some v := by
    induction t generalizing v i <;> simp_all [Term.fold, Term.accuM, Option.bind_eq_some]
    case abs τ t' ih =>
...
theorem Term.fold_accu_Option_function_true
    ...
    Term.accuM
      ...
      t
      i = some () := by
    induction t generalizing i <;> simp_all [Term.fold, Term.accuM, Option.bind_eq_some, guard]
    case abs τ t' ih =>
...
attribute [local simp]
  ...
  optBind_bind
in
theorem Term.unfold_support_ok :
